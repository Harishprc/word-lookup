"""Unit tests for sync.py — HTTP mocked, no token/network needed. Merge
tests mirror android/app/src/test/.../SyncMergerTest.kt case-for-case so
both implementations are pinned to the identical rule."""
